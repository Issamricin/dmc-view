...
from dmc_view import __version__

this_file_location = os.path.dirname(os.path.realpath(os.path.abspath(__file__)))


def version_msg():
    """dmc_view version, location and Python version.

    Get message about dmc_view version, location
    and Python version.
    """
    python_version = sys.version[:3]
    message = u"DMC View %(version)s from {} (Python {})"
